...
HD_PWD='E:/NekrasovVladiimir/CNN_project_start/CNN_project_start.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Top_YOLOv3_Tiny_Project.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Top_YOLOv3_Tiny_Project.tcl
