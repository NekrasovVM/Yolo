...
HD_PWD='E:/NekrasovVladiimir/CNN_project_start/CNN_project_start.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Top_YOLOv3_Tiny_Project.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Top_YOLOv3_Tiny_Project.tcl -notrace
