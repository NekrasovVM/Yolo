...
HD_PWD='E:/Nekrasov Vladiimir/CNN_project_start/CNN_project_start.runs/FIFO_for_MaxpoolS1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FIFO_for_MaxpoolS1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FIFO_for_MaxpoolS1.tcl
