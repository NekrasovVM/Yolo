...
#
# Generated by export_simulation on Tue Nov 29 12:48:04 +0300 2022
#
################################################################################
...
'-reset_run' switch to the './FIFO_for_MaxpoolS1.sh' script.

./FIFO_for_MaxpoolS1.sh -reset_run
...
./FIFO_for_MaxpoolS1.sh -noclean_files

For more information on the script, please type './FIFO_for_MaxpoolS1.sh -help'.
