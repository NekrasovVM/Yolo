...
#
# Generated by export_simulation on Tue Apr 04 19:32:35 +0300 2023
#
################################################################################
...
'-reset_run' switch to the './float_sum.sh' script.

./float_sum.sh -reset_run
...
./float_sum.sh -noclean_files

For more information on the script, please type './float_sum.sh -help'.
