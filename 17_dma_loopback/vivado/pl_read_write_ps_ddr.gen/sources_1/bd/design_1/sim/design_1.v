...
module design_1
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 S_AXI_HP0 " *) input [7:0]S_AXI_HP0_arlen;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 S_AXI_HP0 " *) input S_AXI_HP0_arlock;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 S_AXI_HP0 " *) input S_AXI_HP0_aruser;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 S_AXI_HP0 " *) input S_AXI_HP0_arvalid;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 S_AXI_HP0 " *) input [48:0]S_AXI_HP0_awaddr;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 S_AXI_HP0 " *) input [7:0]S_AXI_HP0_awlen;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 S_AXI_HP0 " *) input S_AXI_HP0_awlock;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 S_AXI_HP0 " *) input S_AXI_HP0_awuser;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.AXI_HP_CLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.AXI_HP_CLK, ASSOCIATED_BUSIF S_AXI_HP0, CLK_DOMAIN design_1_axi_hp_clk, FREQ_HZ 150000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.000" *) input axi_hp_clk;
