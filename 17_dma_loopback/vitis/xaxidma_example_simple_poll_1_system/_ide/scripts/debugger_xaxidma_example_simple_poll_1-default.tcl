...
# Path of this script: E:\NekrasovVladiimir\Training\17_dma_loopback\vitis\xaxidma_example_simple_poll_1_system\_ide\scripts\debugger_xaxidma_example_simple_poll_1-default.tcl
# 
# 
# Usage with xsct:
# To debug using xsct, launch xsct and run below command
# source E:\NekrasovVladiimir\Training\17_dma_loopback\vitis\xaxidma_example_simple_poll_1_system\_ide\scripts\debugger_xaxidma_example_simple_poll_1-default.tcl
# 
...
set bp_2_0_fsbl_bp [bpadd -addr &XFsbl_Exit]
con -block -timeout 60
bpremove $bp_2_0_fsbl_bp
targets -set -nocase -filter {name =~ "*A53*#0"}
rst -processor
