...
# Path of this script: E:\NekrasovVladiimir\Training\17_dma_loopback\vitis\xaxidma_example_simple_poll_2_system\_ide\scripts\debugger_xaxidma_example_simple_poll_2-default.tcl
# 
# 
# Usage with xsct:
# To debug using xsct, launch xsct and run below command
# source E:\NekrasovVladiimir\Training\17_dma_loopback\vitis\xaxidma_example_simple_poll_2_system\_ide\scripts\debugger_xaxidma_example_simple_poll_2-default.tcl
# 
...
fpga -file E:/NekrasovVladiimir/Training/17_dma_loopback/vitis/xaxidma_example_simple_poll_2/_ide/bitstream/design_1_wrapper.bit
targets -set -nocase -filter {name =~"APU*"}
...
targets -set -nocase -filter {name =~ "*A53*#0"}
rst -processor
dow E:/NekrasovVladiimir/Training/17_dma_loopback/vitis/xaxidma_example_simple_poll_2/Debug/xaxidma_example_simple_poll_2.elf
